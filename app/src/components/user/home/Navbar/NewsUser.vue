          ...
          <div class="content">
            <div class="announcement-listing" v-for="announcement in paginatedAnnouncements" :key="announcement.id">
              ...
              <div class="announcement-details mt-4">
                <a :href="announcement.detail" target="_blank" class="news-link">คลิ๊กเพื่อดูรายละเอียด</a> <br>
              ...
              <!-- <div v-if="announcement.pdfFile" class="announcement-details mt-4">
                <a :href="getFileTypeUrl(announcement.pdfFile)" target="_blank" class="news-link">ดาวน์โหลด PDF</a>
              </div>
              <div v-else></div> -->
            </div>
          </div>
