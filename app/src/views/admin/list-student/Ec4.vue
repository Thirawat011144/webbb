  ...
  <section class="content mt-4">
    <div class="card">
      <div class="card-header">
        <div class="card-title mb-2">ข้อมูลนักศึกษาชั้นปริญาตรี ชั้นปีที่ 4 (ทั้งหมด)
          <div>
            ...
            <router-link :to="`/admin-index/Ec4-success`"> <button class="btn btn-success m-1">ฝึกจบแล้ว</button>
            </router-link>
          </div>
        </div>
        <table class="table">
