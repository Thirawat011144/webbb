    ...
    <div class="card">
      <div class="card-header">
        <div class="card-title mb-2">ข้อมูลนักศึกษาชั้นปริญาตรี ชั้นปีที่ 2
          <div>
            <router-link :to="`/admin-index/Ec2-req`"> <button class="btn btn-primary m-1">ขออนุมัติ</button></router-link>
            <router-link :to="`/admin-index/Ec2-active`"> <button class="btn btn-warning m-1">กำลังฝึก</button></router-link>
            <router-link :to="`/admin-index/Ec2-success`">  <button class="btn btn-success m-1">ฝึกจบแล้ว</button> </router-link>
          </div>
        </div>
        <table class="table">
          <thead>
